...
//   { title: "Business & Startups", description: "Register your company, navigate licenses, and launch your venture.", href: "/services/business-startup", icon: Briefcase },
...
//             >
//               <Search size={17} />
//               <span className="search-trigger-text">Search services…</span>
//             </button>
//           </div>
//         </div>
//       </header>
...
//                     <p className="search-no-result-title">No results found for <strong>"{query}"</strong></p>
//                     <button
//                       type="button"
//                       className="search-no-result-reset"
//                       onClick={() => setQuery("")}
//                     >
//                       Clear and show all services
//                     </button>
//                   </div>
//                 </li>
//               )}
